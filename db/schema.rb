...
ActiveRecord::Schema.define(version: 2023_02_23_073312) do
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchased_item_id"], name: "index_buyers_on_purchased_item_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "pronounce_firstname", null: false
    t.string "pronounce_lastname", null: false
  ...
  add_foreign_key "buyers", "purchased_items"
